...
/// and writes a Zig source file (default: `bin/mnist/embedded_images.zig`)
/// containing:
...
///   zig run bin/mnist/gen_embedded_images.zig -- \
///     --input-dir bin/mnist/test_images \
///     --output bin/mnist/embedded_images.zig
///
/// Notes:
...
fn parseArgs(_: std.mem.Allocator, args: []const []const u8) !Options {
    ...
    var output_path: []const u8 = "bin/mnist/embedded_images.zig";
...
fn printHelpAndExit() noreturn {
    std.debug.print(
        ...
        \\
        \\Usage:
        \\  zig run bin/mnist/gen_embedded_images.zig -- [options]
        \\
        \\Options:
