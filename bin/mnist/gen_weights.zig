...
///   zig run bin/mnist/gen_weights.zig -- \
...
pub fn main() !void {
    ...
    try w.writeAll("// Generated by `bin/mnist/gen_weights.zig`.\n");
    try w.writeAll("//\n");
...
fn parseArgs(args: []const []const u8) !Options {
    ...
    var output_path: []const u8 = "bin/mnist/weights.zig";
